...
public class DepositForm extends JDialog {
	...
	public DepositForm() {
		...
		GridBagConstraints gbc_lblDepositAmount = new GridBagConstraints();
		gbc_lblDepositAmount.anchor = GridBagConstraints.EAST;
		gbc_lblDepositAmount.insets = new Insets(0, 0, 5, 5);
		gbc_lblDepositAmount.gridx = 1;
		gbc_lblDepositAmount.gridy = 3;
		contentPane.add(lblDepositAmount, gbc_lblDepositAmount);
		...
		btnSave.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				AccountTransactionPersistence.insertDebitTransaction(accNumber,
						transactionDate,txtComment.getText(), Double.parseDouble(txtDepositAmt.getText()));
				
			}
		});
		
		txtDepositAmt = new JTextField();
		...
		gbc_txtWithdrawAmt.gridy = 3;
		contentPane.add(txtDepositAmt, gbc_txtWithdrawAmt);
		txtDepositAmt.setColumns(10);
		...
		gbc_txtComment.anchor = GridBagConstraints.NORTH;
